...
<div class="container-fluid">
	...
	<div class="row">
		<div class="btn-group col-md-offset-3">
			<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" style="width:83px" aria-expanded="false">
						...
						<table class="table table-bordered table-hover">
						  ...
						  <tbody>
								...
								try {
								    ...
								    con = DriverManager.getConnection(dbURL+dbName, dbUser, dbPass);
								    Statement stmt = con.createStatement();
								    String s="select id,name,uploaded_on,privacy from docs where owner_id="+session.getAttribute("owner");//replace owner id with sessin variable
								    ResultSet rs = stmt.executeQuery(s);
								    int i=1;
								    while(rs.next()){
								       //Retrieve by column name
